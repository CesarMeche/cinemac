...
public class AdminMenu extends JPanel {
    ...
    public AdminMenu(AdminPanel adminPanel) {
        ...
        closeServer= createStyledButton("cerrar server");
    ...
    private void initActions() {
        ...
        closeServer.addActionListener(e -> handleAction("CLOSE"));
    }
    ...
    private void closeServer(){
        adminPanel.getMainFrame().getController().sendMsg(AdminOptions.CLOSE.name(),AdminOptions.CLOSE.name(), null);
        System.exit(0);
    }
